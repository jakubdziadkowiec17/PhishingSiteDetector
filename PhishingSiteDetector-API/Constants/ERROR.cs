namespace PhishingSiteDetector_API.Constants
{
    public static class ERROR
    {
        ...
        public const string DATA_SET_UPLOAD_FAILED = "DATA_SET_UPLOAD_FAILED";
        public const string NO_ACTIVE_DATA_SET_FOUND = "NO_ACTIVE_DATA_SET_FOUND";
        public const string DATA_SET_PREDICTION_FAILED = "DATA_SET_PREDICTION_FAILED";
        public const string GETTING_DATA_SET_LIST_FAILED = "GETTING_DATA_SET_LIST_FAILED";
        public const string DATA_SET_NOT_FOUND = "DATA_SET_NOT_FOUND";
        ...
        public const string INVALID_SORT_FIELD_SPECIFIED = "INVALID_SORT_FIELD_SPECIFIED";
    }
}